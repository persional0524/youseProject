-- 步骤类型: N/A, 步骤名称: 根据reportId删除DM_RFBS_FTYCKK表数据
-- 标签: name, 属性: {}, 内容: 根据reportId删除DM_RFBS_FTYCKK表数据
...
-- 标签: quoteString, 属性: {}, 内容: N
DELETE FROM DM_RFBS_FTYCKK WHERE REPORT_ID = '${reportId}'

-- 标签: set_params, 属性: {}, 内容: N
