  ...
  CREATE TABLE "YSKY_SMS"."GLS_KM_VAL_DETAIL" 
   (	"DETAIL_ID" NUMERIC(*,0) NOT NULL ENABLE, 
	...
	"USER_DEF15" VARCHAR2(30), 
	 CONSTRAINT "PK_GLS_KM_VAL_DETAIL" PRIMARY KEY ("DETAIL_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "T003"  ENABLE, 
	 CONSTRAINT "FK_GLS_KM_VAL_2_DETAIL" FOREIGN KEY ("KV_ID")
	  REFERENCES "YSKY_SMS"."GLS_KM_VAL" ("KV_ID") ENABLE
