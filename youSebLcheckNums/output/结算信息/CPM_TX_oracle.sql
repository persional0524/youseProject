  ...
  CREATE TABLE "YSKY_SMS"."CPM_TX" 
   (	"TX_ID" NUMBER(*,0) NOT NULL ENABLE, 
	"TX_TYPE_ID" NUMBER(*,0), 
	"CHANNEL_ID" NUMBER(*,0) NOT NULL ENABLE, 
	"TX_BIZ_TYPE" NUMBER(*,0), 
	...
	"TX_STATE" NUMBER(*,0) NOT NULL ENABLE, 
	"EXECUTE_FLAG" NUMBER(*,0), 
	"EXEC_RESULT" NUMBER(*,0), 
	...
	"CUR_CODE" VARCHAR2(8), 
	"TX_CLEAR_STATE" NUMBER(*,0), 
	"TX_CLEAR_RESULT" NUMBER(*,0), 
	"INPUTER" VARCHAR2(20), 
	...
	"SPECIAL_TX_FLAG" NUMBER(*,0) DEFAULT 0, 
