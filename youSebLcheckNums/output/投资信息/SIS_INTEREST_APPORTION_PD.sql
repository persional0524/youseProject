  ...
  CREATE TABLE "YSKY_SMS"."SIS_INTEREST_APPORTION_PD" 
   (	"APID" NUMBER(*,0) NOT NULL ENABLE, 
	"FLOW_NO" VARCHAR2(20) NOT NULL ENABLE, 
	"APPORTION_PERIOD" VARCHAR2(10), 
	"APPORTION_DATE" DATE, 
	"BEGIN_APPORTION_COST" NUMBER(20,2), 
	"ACTUAL_INTEREST" NUMBER(20,2), 
	"FUND" NUMBER(20,2), 
	"END_APPORTION_COST" NUMBER(20,2), 
	"CUR_APPORTION_COST" NUMBER(20,2), 
	"APPORTION_BALANCE" NUMBER(20,2), 
	"ACTUAL_RATE" NUMBER(10,2), 
